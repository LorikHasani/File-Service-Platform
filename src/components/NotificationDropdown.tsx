...
import { Bell, Check, CheckCheck, MessageSquare, FileText, FolderOpen } from 'lucide-react';
            ...
            {notifications.length === 0 ? (
              ...
              notifications.map((notif) => {
                ...
                const content = (
                  <div
                    className={clsx(
                      'flex gap-3 px-4 py-3 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors cursor-pointer border-b border-zinc-100 dark:border-zinc-800 last:border-b-0',
